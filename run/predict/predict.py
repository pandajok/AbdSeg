...
from utils.segmentor_predict import SegmentationInfer


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='full functional execute script of flare seg module.')
    parser.add_argument('-c', '--config', type=str, default='./predict.yaml', help='config file path')
    parser.add_argument('-i', '--input_path', type=str, default='/workspace/inputs/', help='input path')
    parser.add_argument('-o', '--output_path', type=str, default='/workspace/output/', help='output path')
